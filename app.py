...
import io
import datetime
import pytz  # Library untuk penyesuaian Zona Waktu (WIB)
...
def fetch_bmkg_maritim_data():
    ...
    try:
        ...
        return (True, "OK") if response.status_code == 200 else (False, f"HTTP {response.status_code}")
...
# Garis posisi jam sekarang sesuai WIB
